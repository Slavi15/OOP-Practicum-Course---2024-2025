...
<h1 align="center">Двоични файлове. Запазване и четене на обекти от двоичен файл. Пример за запазване/четене на масив от обекти (от един тип) във файл. Работа с fstream.</h1>
